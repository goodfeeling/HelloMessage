...
$modelLabel = new \backend\models\ActivityCommentModel();
?>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table-responsive">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <?php ActiveForm::begin(['id' => 'activity-comment-search-form', 'method' => 'get', 'options' => ['class' => 'form-inline'], 'action' => Url::toRoute('activity-comment/index')]); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "activity-comment-form", "class" => "form-horizontal", "action" => Url::toRoute("activity-comment/save")]); ?>

                <input type="hidden" class="form-control" id="id" name="id"/>

                <div id="aid_div" class="form-group">
                    <label for="aid"
                           class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("aid") ?></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="aid" name="ActivityCommentModel[aid]"
                               placeholder="必填"/>
                    </div>
                ...
                <div id="content_div" class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="content" name="ActivityCommentModel[content]"
                               placeholder="必填"/>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div id="addtime_div" class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="addtime" name="ActivityCommentModel[addtime]"
                               placeholder="必填"/>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div id="status_div" class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="status" name="ActivityCommentModel[status]"
                               placeholder="必填"/>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div id="uid_div" class="form-group">
                    <label for="uid"
                           class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("uid") ?></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="uid" name="ActivityCommentModel[uid]"
                               placeholder="必填"/>
                    </div>
                    <div class="clearfix"></div>
                </div>
...
<script>
    ...
    function searchAction() {
        $('#activity-comment-search-form').submit();
    }
    ...
    function initModel(id, type, fun) {
        ...
        $.ajax({
            type: "GET",
            url: "<?=Url::toRoute('activity-comment/view')?>",
            data: {"id": id},
            cache: false,
            dataType: "json",
    ...
    function deleteAction(id) {
        ...
        if (ids.length > 0) {
            admin_tool.confirm('请确认是否删除', function () {
                $.ajax({
                    type: "GET",
                    url: "<?=Url::toRoute('activity-comment/delete')?>",
                    data: {"ids": ids},
                    cache: false,
                    dataType: "json",
                    error: function (xmlHttpRequest, textStatus, errorThrown) {
    ...
    $('#activity-comment-form').bind('submit', function (e) {
        e.preventDefault();
        var id = $("#id").val();
        var action = id == "" ? "<?=Url::toRoute('activity-comment/create')?>" : "<?=Url::toRoute('activity-comment/update')?>";
        $(this).ajaxSubmit({
            type: "post",
            dataType: "json",
            url: action,
