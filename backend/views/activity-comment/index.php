	...
	<div class="modal-dialog">
		<div class="modal-content">
          ...
          <div id="aid_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="aid" name="ActivityCommentModel[aid]" placeholder="必填" />
              </div>
          ...
          <div id="content_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="content" name="ActivityCommentModel[content]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="addtime_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="addtime" name="ActivityCommentModel[addtime]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
