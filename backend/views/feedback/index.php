...
$modelLabel = new \backend\models\FeedbackModel();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table-responsive">
            <!-- row start search-->
          	<div class="row">
          	<div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'feedback-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('feedback/index')]); ?>     
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "feedback-form", "class"=>"form-horizontal", "action"=>Url::toRoute("feedback/save")]); ?>                      
          ...
          <div id="title_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="title" name="FeedbackModel[title]" placeholder="必填" />
              </div>
          ...
          <div id="content_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="content" name="FeedbackModel[content]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="addtime_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="addtime" name="FeedbackModel[addtime]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="type_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="type" name="FeedbackModel[type]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
...
function deleteAction(id){
	...
	if(ids.length > 0){
		admin_tool.confirm('请确认是否删除', function(){
		    $.ajax({
				   type: "GET",
				   url: "<?=Url::toRoute('feedback/delete')?>",
				   data: {"ids":ids},
				   cache: false,
				   dataType:"json",
				   error: function (xmlHttpRequest, textStatus, errorThrown) {
...
$('#feedback-form').bind('submit', function(e) {
	e.preventDefault();
	var id = $("#id").val();
	var action = id == "" ? "<?=Url::toRoute('feedback/create')?>" : "<?=Url::toRoute('feedback/update')?>";
    $(this).ajaxSubmit({
    	type: "post",
    	dataType:"json",
    	url: action,
