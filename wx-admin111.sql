...
-- ----------------------------
BEGIN;
INSERT INTO `admin_activity` VALUES (2, 'test', '2020-07-01 16:54:47', '2020-06-05 11:45:00', '100|10', '<blockquote><blockquote><p></p><p></p><p></p><p></p><h1>asdasdads</h1></blockquote></blockquote><p></p>', '12', 1, 1, '联谊', 159, 2, 30, 1);
...
INSERT INTO `admin_activity` VALUES (4, 'test3', '2020-07-01 18:34:34', '2020-06-21 22:58:00', '100|10', '<p>asdasdasd</p>', '12', 12, 1, '联谊12', 159, 2, 438, 3);
...
CREATE TABLE `admin_activity_likes_user` (
  ...
  `aid` int(11) NOT NULL COMMENT '活动id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户点赞';
...
CREATE TABLE `admin_feedback` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='意见反馈表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2279 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统日志表';
...
CREATE TABLE `admin_user` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=160 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户表';

-- ----------------------------
-- Records of admin_user
-- ----------------------------
BEGIN;
INSERT INTO `admin_user` VALUES (156, 'admin', '$2y$13$9O6bKJieocg//oSax9fZOOuljAKarBXknqD8.RyYg60FfNjS7SoqK', NULL, '113.68.66.9', 'n', NULL, 10, 'admin', '2014-07-07 00:05:47', 'admin', '2014-09-03 12:19:12', 0, '', '', '', '', '', NULL);
...
INSERT INTO `admin_user` VALUES (159, 'oeailwsked41rfDRR2VEpq4bbh2I', '$2y$05$x6evM.6pI.LHaJbGuVgc4etx/Aj8.1HXxDch2J5e/YVTEmETY7XIe', NULL, '219.136.74.189', 'n', NULL, 10, 'front', '0000-00-00 00:00:00', 'front', '0000-00-00 00:00:00', 2, '34_xzUCnEZ911J8gBYTGXFROib9eH_OA7EjfomDUKKV1xBlKc8gjQD2b869INjmzaBACNp79yQt43xB-tTVFmxXNCvBf00Y7j1mzPwW7Z840KE', 'oeailwsked41rfDRR2VEpq4bbh2I', 'Edward', 'http://thirdwx.qlogo.cn/mmopen/vi_32/XtRviaT0jQ6mMcQDBicHh23Rs8GyVXicQicNhhPAgw1P4SeribRnwjniasibEHd5ibqJkRFrtbzuwnaX5kBicMdYfceDAog/132', NULL, '');
COMMIT;
