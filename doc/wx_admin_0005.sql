...
CREATE TABLE `admin_activity`  (
  ...
  `addtime` datetime(0) NOT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '报名时间',
  `endtime` datetime(0) NOT NULL COMMENT '截止时间',
  ...
  `pic_url_id` tinyint(1) NULL DEFAULT NULL COMMENT '大图id',
...
CREATE TABLE `admin_activity_comments`  (
  ...
  `addtime` datetime(0) NOT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '添加时间',
...
CREATE TABLE `admin_activity_likes_user`  (
  ...
  `aid` int(11) NOT NULL COMMENT '活动id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户点赞' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `admin_feedback`  (
  ...
  `addtime` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '提交时间',
  `type` tinyint(1) NULL DEFAULT 0 COMMENT '反馈类型',
  PRIMARY KEY (`id`) USING BTREE
...
) ENGINE = InnoDB AUTO_INCREMENT = 2146 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统日志表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `admin_mail_setting`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `send_mail` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '发件人邮箱',
  `send_pwd` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '授权码',
  `send_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '发件平台名称',
  `receive_mail` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '收件人邮箱',
  `status` tinyint(1) NULL DEFAULT NULL COMMENT '状态',
  `addtime` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '邮件设置' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `admin_module`  (
  ...
  `update_date` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '模块表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 202 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单的url表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 575 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限导航栏表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `admin_system`  (
  ...
  `aid` int(11) NOT NULL COMMENT '活动id',
  `title` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '地图标题',
  `content` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '地图内容',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统设置' ROW_FORMAT = Dynamic;
...
CREATE TABLE `admin_user_avatar`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户头像设置' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of admin_user_avatar
-- ----------------------------
...
CREATE TABLE `admin_wechat_config`  (
  ...
  `encodingaeskey` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '安全加密密钥',
  PRIMARY KEY (`id`) USING BTREE
