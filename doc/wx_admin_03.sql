...
) ENGINE=InnoDB AUTO_INCREMENT=1241 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统日志表';
...
-- ----------------------------
BEGIN;
INSERT INTO `admin_order` VALUES (1, 'Akkk', 1, 2, 1);
COMMIT;
