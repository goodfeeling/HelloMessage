...
-- ----------------------------
BEGIN;
INSERT INTO `admin_activity` VALUES (2, 'test', '2020-06-11 16:19:00', '2020-06-12 16:20:00', '111');
COMMIT;
...
CREATE TABLE `admin_activity_user` (
  ...
  `is_pay` tinyint(1) NOT NULL COMMENT '是否支付0 未支付 1已支付',
  `is_join` tinyint(1) NOT NULL COMMENT '是否参加活动',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='活动人员表';
...
) ENGINE=InnoDB AUTO_INCREMENT=374 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=152 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单的url表';
...
) ENGINE=InnoDB AUTO_INCREMENT=309 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='权限导航栏表';
...
INSERT INTO `admin_role_right` VALUES (292, 1, 13, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (293, 1, 14, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (294, 1, 15, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (295, 1, 16, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (296, 1, 17, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (297, 1, 18, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (298, 1, 19, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (299, 1, 20, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (300, 1, 21, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (301, 1, 4, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (302, 1, 5, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (303, 1, 6, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (304, 1, 7, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (305, 1, 8, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (306, 1, 22, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (307, 1, 24, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
INSERT INTO `admin_role_right` VALUES (308, 1, 23, NULL, 'admin', '2020-06-03 14:23:44', 'admin', '2020-06-03 14:23:44');
COMMIT;
